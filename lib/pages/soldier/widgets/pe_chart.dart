...
class _PeChartState extends State<PeChart> {
  ...
  Widget _getLineChart() {
    ...
    return Container(
      child: SfCartesianChart(
        ...
        series: <LineSeries<Linesales, String>>[
          LineSeries<Linesales, String>(
              dataSource: dataLine,
              xValueMapper: (Linesales lines ,_) => lines.time.toString(),
              yValueMapper: (Linesales lines ,_) => lines.sale
              )
        ],
      ),
    );
  ...
  Widget _getLine() {
    ...
    Widget line = charts.TimeSeriesChart(
      seriesLine,
    );
